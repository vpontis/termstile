$(document).ready(function(){
	$("#submit").click(function(){
		$.getJSON("http://en.wikipedia.org//w/api.php?action=query&prop=revisions&format=json&rvprop=content&rvlimit=1&redirects&indexpageids&titles="+$('#oneTerm').val()+"&callback=?",
		function(data){
			console.log(data);
