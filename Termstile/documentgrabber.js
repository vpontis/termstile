function createBox(id, title) {
	...
	var text = "<div onMouseOver=\"showDeleteButton(\'" + closeId + "\')\"onMouseOut=\"hideDeleteButton(\'"+closeId+"\')\" ><strong>"+title+"<img src=\"../media/card.png\" id='getCardsButton' class=\"smallButton\" onClick='getCards("+id+", \""+title+"\")\' /><img src=\"../media/guide.png\" id='getGuideButton' class=\"smallButton\" onClick='getGuide("+id+", \""+title+"\")\'/></div>";
