...
function createBox() {
	...
	var text = "<div style=\"text-align:center\"><a id=\'loadingclose\' onclick=\'removeElement("+divIdName+")\'><img id=\'"+closeId+"\' style=\'display:none\' src=\'media/closebutton.png\' /></a></div>"
	$(newDiv).html(text);
	...
	getText(searchTerm,function(summary){
		...
		answer += " <a class=\'close\' onclick=\'removeElement("+divIdName+", "+thisDivNum+")\'><img id=\'"+closeId+"\' style=\'display:none\' src=\'media/closebutton.png\' /></a>";
